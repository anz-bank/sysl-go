...
RUN curl -LJO https://github.com/arr-ai/arrai/releases/download/v0.188.0/arrai_v0.188.0_linux-amd64.tar.gz && tar -xvf arrai_v0.188.0_linux-amd64.tar.gz && mv arrai /bin/arrai
