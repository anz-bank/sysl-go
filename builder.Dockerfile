...
RUN curl -LJO https://github.com/golangci/golangci-lint/releases/download/v2.12.2/golangci-lint-2.12.2-linux-amd64.tar.gz && tar -xvf golangci-lint-2.12.2-linux-amd64.tar.gz && mv golangci-lint-2.12.2-linux-amd64/golangci-lint /bin/golangci-lint
