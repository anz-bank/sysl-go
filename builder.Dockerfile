...
RUN curl -LJO https://github.com/arr-ai/arrai/releases/download/v0.194.0/arrai_v0.194.0_linux-amd64.tar.gz && tar -xvf arrai_v0.194.0_linux-amd64.tar.gz && mv arrai /bin/arrai
