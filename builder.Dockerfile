...
RUN curl -LJO https://github.com/anz-bank/sysl/releases/download/v0.249.0/sysl_0.249.0_linux-amd64.tar.gz && tar -xvf sysl_0.249.0_linux-amd64.tar.gz && mv sysl /bin/sysl
