...
SIMPLEGRPC_SYSL_FILES=$(addprefix $(SIMPLEGRPC_OUT)/simple/, $(GRPC_SERVER_FILES))
...
simplegrpc-gen: OUT=$(SIMPLEGRPC_OUT)/simple
...
$(SIMPLEGRPC_OUT)/simple/%.go: $(TRANSFORMS)/%.sysl
	$(run-sysl)
